/*
  ...
  gengetopt -i src/tools/roc_send/cmdline.ggo -F cmdline --output-dir build/src/x86_64-pc-linux-gnu/clang-22.1.8-release/tools/roc_send --set-version 0.4.0 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->track_help = gengetopt_args_info_help[16] ;
  args_info->track_min = 0;
  args_info->track_max = 0;
  args_info->slot_name_help = gengetopt_args_info_help[17] ;
  args_info->slot_name_min = 0;
  args_info->slot_name_max = 0;
  args_info->packet_encoding_help = gengetopt_args_info_help[19] ;
  args_info->packet_len_help = gengetopt_args_info_help[20] ;
  args_info->fec_encoding_help = gengetopt_args_info_help[21] ;
  args_info->fec_block_src_help = gengetopt_args_info_help[22] ;
  args_info->fec_block_rpr_help = gengetopt_args_info_help[23] ;
  args_info->latency_backend_help = gengetopt_args_info_help[24] ;
  args_info->latency_profile_help = gengetopt_args_info_help[25] ;
  args_info->resampler_backend_help = gengetopt_args_info_help[26] ;
  args_info->resampler_profile_help = gengetopt_args_info_help[27] ;
  ...
  args_info->auto_cts_help = gengetopt_args_info_help[35] ;
  args_info->prometheus_metrics_port_help = gengetopt_args_info_help[37] ;
  args_info->prometheus_niq_latency_buckets_help = gengetopt_args_info_help[38] ;
  args_info->prometheus_niq_latency_min_help = gengetopt_args_info_help[39] ;
  args_info->prometheus_niq_latency_max_help = gengetopt_args_info_help[40] ;
  args_info->prometheus_niq_latency_scale_help = gengetopt_args_info_help[41] ;
  args_info->prometheus_e2e_latency_buckets_help = gengetopt_args_info_help[42] ;
  args_info->prometheus_e2e_latency_min_help = gengetopt_args_info_help[43] ;
  args_info->prometheus_e2e_latency_max_help = gengetopt_args_info_help[44] ;
  args_info->prometheus_e2e_latency_scale_help = gengetopt_args_info_help[45] ;
  args_info->prometheus_jitter_buckets_help = gengetopt_args_info_help[46] ;
  args_info->prometheus_jitter_min_help = gengetopt_args_info_help[47] ;
  args_info->prometheus_jitter_max_help = gengetopt_args_info_help[48] ;
  args_info->prometheus_jitter_scale_help = gengetopt_args_info_help[49] ;
  args_info->prometheus_rtt_buckets_help = gengetopt_args_info_help[50] ;
  args_info->prometheus_rtt_min_help = gengetopt_args_info_help[51] ;
  args_info->prometheus_rtt_max_help = gengetopt_args_info_help[52] ;
  args_info->prometheus_rtt_scale_help = gengetopt_args_info_help[53] ;
