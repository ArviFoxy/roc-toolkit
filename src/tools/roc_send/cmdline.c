...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_packet_size_help = gengetopt_args_info_help[35] ;
  args_info->max_frame_size_help = gengetopt_args_info_help[36] ;
  args_info->prof_help = gengetopt_args_info_help[38] ;
  args_info->dump_help = gengetopt_args_info_help[39] ;
