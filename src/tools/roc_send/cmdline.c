/*
  ...
  gengetopt -i cmdline.ggo -F cmdline --output-dir . --set-version 0.4.0 (205ff68d52) 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_packet_size_help = gengetopt_args_info_help[55] ;
  args_info->max_frame_size_help = gengetopt_args_info_help[56] ;
  args_info->prof_help = gengetopt_args_info_help[58] ;
  args_info->dump_help = gengetopt_args_info_help[59] ;
