/*
  ...
  gengetopt --no-version --output-dir=. --input=cmdline.ggo 
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --track=TRACKS            Input track(s) sent to the corresponding\n                                  --source endpoint, e.g. '0', '2', or '0-1'\n                                  (requires multitrack --io-encoding)",
  "      --slot-name=NAME          Name of the corresponding --source slot,\n                                  attached as 'slot' label to exported metrics",
  "\nEncoding options:",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->track_orig = NULL;
  args_info->slot_name_arg = NULL;
  args_info->slot_name_orig = NULL;
  ...
  args_info->prometheus_playout_spread_buckets_arg = 40;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->verbose_help = gengetopt_args_info_help[1] ;
  args_info->verbose_min = 0;
  args_info->verbose_max = 0;
  args_info->color_help = gengetopt_args_info_help[2] ;
  args_info->list_supported_help = gengetopt_args_info_help[3] ;
  args_info->input_help = gengetopt_args_info_help[5] ;
  args_info->io_encoding_help = gengetopt_args_info_help[6] ;
  args_info->io_latency_help = gengetopt_args_info_help[7] ;
  args_info->io_frame_len_help = gengetopt_args_info_help[8] ;
  args_info->source_help = gengetopt_args_info_help[10] ;
  args_info->source_min = 0;
  args_info->source_max = 0;
  args_info->repair_help = gengetopt_args_info_help[11] ;
  args_info->repair_min = 0;
  args_info->repair_max = 0;
  args_info->control_help = gengetopt_args_info_help[12] ;
  args_info->control_min = 0;
  args_info->control_max = 0;
  args_info->miface_help = gengetopt_args_info_help[13] ;
  args_info->miface_min = 0;
  args_info->miface_max = 0;
  args_info->reuseaddr_help = gengetopt_args_info_help[14] ;
  args_info->track_help = gengetopt_args_info_help[15] ;
  args_info->track_min = 0;
  args_info->track_max = 0;
  args_info->slot_name_help = gengetopt_args_info_help[16] ;
  args_info->slot_name_min = 0;
  args_info->slot_name_max = 0;
  args_info->packet_encoding_help = gengetopt_args_info_help[18] ;
  args_info->packet_len_help = gengetopt_args_info_help[19] ;
  args_info->fec_encoding_help = gengetopt_args_info_help[20] ;
  args_info->fec_block_src_help = gengetopt_args_info_help[21] ;
  args_info->fec_block_rpr_help = gengetopt_args_info_help[22] ;
  ...
  args_info->auto_cts_help = gengetopt_args_info_help[34] ;
  args_info->prometheus_metrics_port_help = gengetopt_args_info_help[36] ;
  args_info->prometheus_niq_latency_buckets_help = gengetopt_args_info_help[37] ;
  args_info->prometheus_niq_latency_min_help = gengetopt_args_info_help[38] ;
  args_info->prometheus_niq_latency_max_help = gengetopt_args_info_help[39] ;
  args_info->prometheus_niq_latency_scale_help = gengetopt_args_info_help[40] ;
  args_info->prometheus_e2e_latency_buckets_help = gengetopt_args_info_help[41] ;
  args_info->prometheus_e2e_latency_min_help = gengetopt_args_info_help[42] ;
  args_info->prometheus_e2e_latency_max_help = gengetopt_args_info_help[43] ;
  args_info->prometheus_e2e_latency_scale_help = gengetopt_args_info_help[44] ;
  args_info->prometheus_jitter_buckets_help = gengetopt_args_info_help[45] ;
  args_info->prometheus_jitter_min_help = gengetopt_args_info_help[46] ;
  args_info->prometheus_jitter_max_help = gengetopt_args_info_help[47] ;
  args_info->prometheus_jitter_scale_help = gengetopt_args_info_help[48] ;
  args_info->prometheus_rtt_buckets_help = gengetopt_args_info_help[49] ;
  args_info->prometheus_rtt_min_help = gengetopt_args_info_help[50] ;
  args_info->prometheus_rtt_max_help = gengetopt_args_info_help[51] ;
  args_info->prometheus_rtt_scale_help = gengetopt_args_info_help[52] ;
  args_info->prometheus_playout_spread_buckets_help = gengetopt_args_info_help[53] ;
  args_info->prometheus_playout_spread_min_help = gengetopt_args_info_help[54] ;
  args_info->prometheus_playout_spread_max_help = gengetopt_args_info_help[55] ;
  args_info->max_packet_size_help = gengetopt_args_info_help[57] ;
  args_info->max_frame_size_help = gengetopt_args_info_help[58] ;
  args_info->prof_help = gengetopt_args_info_help[60] ;
  args_info->dump_help = gengetopt_args_info_help[61] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_string_field (args_info->track_given, &(args_info->track_arg), &(args_info->track_orig));
  free_multiple_string_field (args_info->slot_name_given, &(args_info->slot_name_arg), &(args_info->slot_name_orig));
  ...
  free_string_field (&(args_info->prometheus_playout_spread_buckets_orig));
  free_string_field (&(args_info->prometheus_playout_spread_min_arg));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->track_given, "track", args_info->track_orig, 0);
  write_multiple_into_file(outfile, args_info->slot_name_given, "slot-name", args_info->slot_name_orig, 0);
  ...
  if (args_info->prometheus_playout_spread_buckets_given)
    write_into_file(outfile, "prometheus-playout-spread-buckets", args_info->prometheus_playout_spread_buckets_orig, 0);
  if (args_info->prometheus_playout_spread_min_given)
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->track_given, args_info->track_min, args_info->track_max, "'--track'"))
     error_occurred = 1;
  
  if (check_multiple_option_occurrences(prog_name, args_info->slot_name_given, args_info->slot_name_min, args_info->slot_name_max, "'--slot-name'"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * track_list = NULL;
  struct generic_list * slot_name_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hvLi:s:r:c:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Input track(s) sent to the corresponding --source endpoint, e.g. '0', '2', or '0-1' (requires multitrack --io-encoding).  */
          else if (strcmp (long_options[option_index].name, "track") == 0)
          {
          
            if (update_multiple_arg_temp(&track_list, 
                &(local_args_info.track_given), optarg, 0, 0, ARG_STRING,
                "track", '-',
                additional_error))
              goto failure;
          
          }
          /* Name of the corresponding --source slot, attached as 'slot' label to exported metrics.  */
          else if (strcmp (long_options[option_index].name, "slot-name") == 0)
          {
          
            if (update_multiple_arg_temp(&slot_name_list, 
                &(local_args_info.slot_name_given), optarg, 0, 0, ARG_STRING,
                "slot-name", '-',
                additional_error))
              goto failure;
          ...
          /* Number of histogram buckets for playout spread metric.  */
          else if (strcmp (long_options[option_index].name, "prometheus-playout-spread-buckets") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->prometheus_playout_spread_buckets_arg), 
                 &(args_info->prometheus_playout_spread_buckets_orig), &(args_info->prometheus_playout_spread_buckets_given),
                &(local_args_info.prometheus_playout_spread_buckets_given), optarg, 0, "40", ARG_INT,
                check_ambiguity, override, 0, 0,
                "prometheus-playout-spread-buckets", '-',
                additional_error))
              goto failure;
          
          }
          /* Minimum playout spread bucket boundary, TIME units.  */
          else if (strcmp (long_options[option_index].name, "prometheus-playout-spread-min") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->prometheus_playout_spread_min_arg), 
                 &(args_info->prometheus_playout_spread_min_orig), &(args_info->prometheus_playout_spread_min_given),
                &(local_args_info.prometheus_playout_spread_min_given), optarg, 0, "10us", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "prometheus-playout-spread-min", '-',
                additional_error))
              goto failure;
          
          }
          /* Maximum playout spread bucket boundary, TIME units.  */
          else if (strcmp (long_options[option_index].name, "prometheus-playout-spread-max") == 0)
          {
  ...
  update_multiple_arg((void *)&(args_info->track_arg),
    &(args_info->track_orig), args_info->track_given,
    local_args_info.track_given, 0,
    ARG_STRING, track_list);
  update_multiple_arg((void *)&(args_info->slot_name_arg),
    &(args_info->slot_name_orig), args_info->slot_name_given,
    local_args_info.slot_name_given, 0,
    ARG_STRING, slot_name_list);
  ...
  local_args_info.miface_given = 0;
  args_info->track_given += local_args_info.track_given;
  local_args_info.track_given = 0;
  args_info->slot_name_given += local_args_info.slot_name_given;
  local_args_info.slot_name_given = 0;
...
failure:
  ...
  free_list (track_list, 1 );
  free_list (slot_name_list, 1 );
