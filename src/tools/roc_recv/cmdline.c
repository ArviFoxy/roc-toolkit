...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->prometheus_rtt_buckets_help = gengetopt_args_info_help[47] ;
  args_info->prometheus_rtt_min_help = gengetopt_args_info_help[48] ;
  args_info->prometheus_rtt_max_help = gengetopt_args_info_help[49] ;
