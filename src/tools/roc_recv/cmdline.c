...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->io_encoding_help = gengetopt_args_info_help[8] ;
  args_info->io_latency_help = gengetopt_args_info_help[9] ;
  args_info->io_frame_len_help = gengetopt_args_info_help[10] ;
  args_info->backup_help = gengetopt_args_info_help[12] ;
  args_info->source_help = gengetopt_args_info_help[14] ;
  args_info->source_min = 0;
  args_info->source_max = 0;
  args_info->repair_help = gengetopt_args_info_help[15] ;
  args_info->repair_min = 0;
  args_info->repair_max = 0;
  args_info->control_help = gengetopt_args_info_help[16] ;
  args_info->control_min = 0;
  args_info->control_max = 0;
  args_info->miface_help = gengetopt_args_info_help[17] ;
  args_info->miface_min = 0;
  args_info->miface_max = 0;
  args_info->reuseaddr_help = gengetopt_args_info_help[18] ;
  args_info->packet_encoding_help = gengetopt_args_info_help[20] ;
  args_info->packet_encoding_min = 0;
  args_info->packet_encoding_max = 0;
  args_info->plc_help = gengetopt_args_info_help[21] ;
  ...
  args_info->latency_aggressiveness_help = gengetopt_args_info_help[26] ;
  ...
  args_info->report_grid_help = gengetopt_args_info_help[37] ;
  args_info->prometheus_metrics_port_help = gengetopt_args_info_help[38] ;
  args_info->prometheus_niq_latency_buckets_help = gengetopt_args_info_help[39] ;
  args_info->prometheus_niq_latency_min_help = gengetopt_args_info_help[40] ;
  args_info->prometheus_niq_latency_max_help = gengetopt_args_info_help[41] ;
  args_info->prometheus_niq_latency_scale_help = gengetopt_args_info_help[42] ;
  args_info->prometheus_e2e_latency_buckets_help = gengetopt_args_info_help[43] ;
  args_info->prometheus_e2e_latency_min_help = gengetopt_args_info_help[44] ;
  args_info->prometheus_e2e_latency_max_help = gengetopt_args_info_help[45] ;
  args_info->prometheus_e2e_latency_scale_help = gengetopt_args_info_help[46] ;
  args_info->prometheus_jitter_buckets_help = gengetopt_args_info_help[47] ;
  args_info->prometheus_jitter_min_help = gengetopt_args_info_help[48] ;
  args_info->prometheus_jitter_max_help = gengetopt_args_info_help[49] ;
  args_info->prometheus_jitter_scale_help = gengetopt_args_info_help[50] ;
  args_info->prometheus_rtt_buckets_help = gengetopt_args_info_help[51] ;
  args_info->prometheus_rtt_min_help = gengetopt_args_info_help[52] ;
  args_info->prometheus_rtt_max_help = gengetopt_args_info_help[53] ;
  args_info->prometheus_rtt_scale_help = gengetopt_args_info_help[54] ;
  args_info->max_packet_size_help = gengetopt_args_info_help[56] ;
  args_info->max_frame_size_help = gengetopt_args_info_help[57] ;
  args_info->prof_help = gengetopt_args_info_help[59] ;
  args_info->dump_help = gengetopt_args_info_help[60] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hvL1o:s:r:c:", long_options, &option_index);
