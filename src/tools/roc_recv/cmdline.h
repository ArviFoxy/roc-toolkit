...
#define CMDLINE_PARSER_PACKAGE "roc-recv"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "roc-recv"
#endif
...
struct gengetopt_args_info
{
  ...
  int oneshot_flag;	/**< @brief Exit when last connection is closed (default=off).  */
  const char *oneshot_help; /**< @brief Exit when last connection is closed help description.  */
  char * output_arg;	/**< @brief Output file or device URI.  */
  char * output_orig;	/**< @brief Output file or device URI original value given at command line.  */
  const char *output_help; /**< @brief Output file or device URI help description.  */
  char * io_encoding_arg;	/**< @brief Output device encoding.  */
  char * io_encoding_orig;	/**< @brief Output device encoding original value given at command line.  */
  const char *io_encoding_help; /**< @brief Output device encoding help description.  */
  char * io_latency_arg;	/**< @brief Output device latency, TIME units.  */
  char * io_latency_orig;	/**< @brief Output device latency, TIME units original value given at command line.  */
  const char *io_latency_help; /**< @brief Output device latency, TIME units help description.  */
  char * io_frame_len_arg;	/**< @brief Output frame length, TIME units.  */
  char * io_frame_len_orig;	/**< @brief Output frame length, TIME units original value given at command line.  */
  const char *io_frame_len_help; /**< @brief Output frame length, TIME units help description.  */
  char * backup_arg;	/**< @brief Backup file URI (used as input when there are no connections).  */
  char * backup_orig;	/**< @brief Backup file URI (used as input when there are no connections) original value given at command line.  */
  const char *backup_help; /**< @brief Backup file URI (used as input when there are no connections) help description.  */
  char ** source_arg;	/**< @brief Local source endpoint to listen on.  */
  char ** source_orig;	/**< @brief Local source endpoint to listen on original value given at command line.  */
  unsigned int source_min; /**< @brief Local source endpoint to listen on's minimum occurreces */
  unsigned int source_max; /**< @brief Local source endpoint to listen on's maximum occurreces */
  const char *source_help; /**< @brief Local source endpoint to listen on help description.  */
  char ** repair_arg;	/**< @brief Local repair endpoint to listen on.  */
  char ** repair_orig;	/**< @brief Local repair endpoint to listen on original value given at command line.  */
  unsigned int repair_min; /**< @brief Local repair endpoint to listen on's minimum occurreces */
  unsigned int repair_max; /**< @brief Local repair endpoint to listen on's maximum occurreces */
  const char *repair_help; /**< @brief Local repair endpoint to listen on help description.  */
  char ** control_arg;	/**< @brief Local control endpoint to listen on.  */
  char ** control_orig;	/**< @brief Local control endpoint to listen on original value given at command line.  */
  unsigned int control_min; /**< @brief Local control endpoint to listen on's minimum occurreces */
  unsigned int control_max; /**< @brief Local control endpoint to listen on's maximum occurreces */
  const char *control_help; /**< @brief Local control endpoint to listen on help description.  */
  ...
  char ** packet_encoding_arg;	/**< @brief Custom network packet encoding(s) (may be used multiple times).  */
  char ** packet_encoding_orig;	/**< @brief Custom network packet encoding(s) (may be used multiple times) original value given at command line.  */
  unsigned int packet_encoding_min; /**< @brief Custom network packet encoding(s) (may be used multiple times)'s minimum occurreces */
  unsigned int packet_encoding_max; /**< @brief Custom network packet encoding(s) (may be used multiple times)'s maximum occurreces */
  const char *packet_encoding_help; /**< @brief Custom network packet encoding(s) (may be used multiple times) help description.  */
  enum enum_plc plc_arg;	/**< @brief Algorithm to mask unrecoverable packet losses (default='none').  */
  char * plc_orig;	/**< @brief Algorithm to mask unrecoverable packet losses original value given at command line.  */
  const char *plc_help; /**< @brief Algorithm to mask unrecoverable packet losses help description.  */
  ...
  enum enum_latency_profile latency_profile_arg;	/**< @brief Latency tuning profile (default='auto').  */
  ...
  unsigned int plc_given ;	/**< @brief Whether plc was given.  */
...
extern const char *cmdline_parser_plc_values[];  /**< @brief Possible values for plc. */
